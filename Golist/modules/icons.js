...
(function() {
    ...
    const ICON_MAP = [
        ...
        { keys: ['brush', 'paste', 'colgate'], emoji: '🪥' },
    ...
    // Main Function attached to WINDOW for global access
    window.getProductIcon = function(name) {
